...
DATA_DIR = "/opt/airflow/taxi_data"
OUTPUT_DIR = "/opt/airflow/taxi_output"
...
with DAG(
    ...
    def clean_data(ingest_result: dict) -> dict:
        ...
        # 2021-2023 schema
        df_old = spark.read.parquet(
            f"{DATA_DIR}/yellow_tripdata_2021-01.parquet",
            f"{DATA_DIR}/yellow_tripdata_2022-01.parquet",
            f"{DATA_DIR}/yellow_tripdata_2023-01.parquet",
        )

        # 2024-2025 schema
        df_new = spark.read.parquet(
            f"{DATA_DIR}/yellow_tripdata_2024-01.parquet",
            f"{DATA_DIR}/yellow_tripdata_2025-01.parquet",
        )
